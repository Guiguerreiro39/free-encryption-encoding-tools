...
export const metadata: Metadata = generatePageMetadata(
  SITE_CONFIG.title.seo,
  SITE_CONFIG.description.default,
  SEO_KEYWORDS.highIntent,
  "/"
);
        ...
        <section className="prose prose-slate dark:prose-invert max-w-none space-y-12">
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 not-prose">
              ...
              <Card>
                ...
                <CardContent>
                  <TypographyP>
                    ...
                    locally in your browser. Your sensitive data never touches
                    our servers, ensuring complete privacy and security.
                  </TypographyP>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <TypographyP>
                    No waiting, no processing delays. Encrypt text, decode
                    Base64, solve Caesar ciphers and generate RSA keys
                    instantly. Perfect for developers, security professionals,
                    and anyone needing quick cryptographic operations.
                  </TypographyP>
                </CardContent>
              </Card>
            ...
            <Card className="not-prose text-start max-w-3xl mx-auto">
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li>
                    <strong>Secure Message Encryption:</strong> Protect
                    sensitive communications with AES or RSA encryption
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Developer Tools:</strong> Quick encoding/decoding
                    for web development and API testing
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Secure File Preparation:</strong> Encrypt text
                    before uploading to cloud services
                  </li>
                </ul>
              </CardContent>
            </Card>
          ...
          <div className="space-y-2">
            ...
            <TypographyP>
              ...
              advanced users, custom keys and initialization vectors are
              supported for maximum security control.
            </TypographyP>
          </div>
        </section>
      </article>
