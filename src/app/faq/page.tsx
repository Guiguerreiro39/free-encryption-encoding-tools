    ...
    <section>
      <Accordion type="multiple" className="space-y-8">
        ...
        <div className="space-y-2">
          <h3 className="font-semibold text-2xl mt-6">Encryption FAQ</h3>
          ...
          <AccordionItem value="encryption-vs-encoding">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              <strong>Encryption</strong> protects data by making it unreadable
              without a secret key. It ensures confidentiality.
              <br />
              <strong>Encoding</strong> is used for compatibility (e.g., Base64)
              and is easily reversible — it does not provide security.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="symmetric-vs-asymmetric">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              <strong>Symmetric encryption</strong> uses one key for encryption
          ...
          <AccordionItem value="what-is-iv">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              ...
              encrypted multiple times yields different ciphertexts. Crucial in
              block cipher modes like CBC and GCM.
            </AccordionContent>
          </AccordionItem>
        ...
        <div className="space-y-2">
          ...
          <AccordionItem value="encrypt-passwords">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              Passwords should be <strong>hashed</strong> using algorithms like{" "}
              <code>bcrypt</code> or <code>Argon2</code>. Hashing is one-way and
              safer for password storage.
            </AccordionContent>
          </AccordionItem>
        ...
        <div className="space-y-2">
          ...
          <AccordionItem value="is-base64-secure">
            <AccordionTrigger>Can Base64 increase file size?</AccordionTrigger>
            <AccordionContent className="text-sm text-muted-foreground">
          ...
          <AccordionItem value="is-base64-secure">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              ASCII uses 7 bits and supports basic English characters. UTF-8 is
              a variable-length encoding that supports all Unicode characters
          ...
          <AccordionItem value="is-base64-secure">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              Encoding transforms data for compatibility (e.g., UTF-8, Base64),
              while serialization converts data into a storable or transmittable
              format (e.g., JSON, XML).
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="is-base64-secure">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              It&apos;s safe but inefficient. Base64-encoded data is larger, so
              it&apos;s often better to store raw binary (e.g., in BLOB fields).
            </AccordionContent>
          </AccordionItem>
        </div>
        ...
        <div className="space-y-2">
          ...
          <AccordionItem value="https-vs-http">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              HTTPS uses TLS to encrypt traffic between browser and server. HTTP
              is unencrypted and insecure for sensitive data.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="how-to-check-site-security">
            ...
            <AccordionContent className="text-sm text-muted-foreground">
              Look for “https://” and a padlock icon in the browser. This means
